...
export const SwirlArrowIcon = ( {className} : Props) => {
    return (
        <svg className={className} width="124" height="101" viewBox="0 0 124 101" fill="none">
            ...
            <defs>
                <clipPath id="clip0_46_948">
                    <rect width="106" height="67" fill="white"
                        transform="matrix(0.932551 0.361039 0.361039 -0.932551 0 62.481)"></rect>
                </clipPath>
            </defs>
        </svg>
    )
